    ...
    <div className='experience-child'>
          ...
          <div className='experience-box'>
            ...
            <div className="icon-delete-update">
            {
                ...
                <>
                <button id='hide' className='icon-button' onClick={()=>handleDeleteExp(props.item.id)}>
              ...
              <button id='hide' onClick={()=>{setCurrClick(props.item.id); setViewUpdateExp(!viewUpdateExp)}} className='icon-button'>
